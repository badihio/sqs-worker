...
class Worker:
    ...
    def __init__(
        ...
        metrics_instrumentator: obsv_tools.metrics.instrumentator.Instrumentator | None = None,
    ...
    def pull_messages(
        ...
        while len(messages) < self.max_messages and wait_time_sec <= wait_for_messages_sec:
    ...
    def publish_messages(
        ...
        for i in range(0, len(messages), MAX_BATCH_SIZE):
            ...
            json_messages: list[mypy_boto3_sqs.type_defs.SendMessageBatchRequestEntryTypeDef] = []
